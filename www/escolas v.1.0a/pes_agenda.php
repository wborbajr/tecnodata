...
function popup(url,nome){
	window.open(url,nome,'width=750','height=50','status=0','toolbar=0');
//	return false;
}
</script>
              ...
              <tr>
                <td class="texto">
                  <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="2">
                    <tr>
                      <td width="15%" class="texto" align="right"><div align="right" class="style1 style2"><b>Consultor (para) </b> </div></td>
                    ...
                    <tr>
                      <td colspan="4"  class="texto"><hr>
                      <p><span class="style7">Legenda</span><br>
                          <span class="style9"> <img src="images/lupa.gif" width="16" height="16"> - Mostra ficha da escola | <img src="images/editar_image.gif" width="19" height="19"> - Altera agenda | <img src="images/excluir_image.gif" width="18" height="15">- Exclui agenda | <img src="images/realizado.gif" width="24" height="16"> - Agendamento realizado </span></p>
                          <hr></td>
                    </tr>
                    <tr bgcolor="#F9F9F9">
                      <td colspan="4" class="texto">
		      <table width="100%"  border="0" cellspacing="1" cellpadding="1">
		          ...
		          ?>
						...
						<? }else{ ?> <tr bgcolor="#EFEFEF"> <? } ?>
                          ...
                          <td align="center">
						  <a onClick="javascript:popup('ficha_escola.php?cod=<? echo $dados["idesc"];?>','Escola');" style="cursor:pointer;"><img src="images/lupa.gif" alt="Ver ficha da escola" width="16" height="16"></a>
						  </td>
                          <td align="center">
                          ...
                          <td align="center">
				        <a onClick="if(confirm('Deseja marcar como realizado ?')){processa('<? echo $dados["idage"]; ?>','realizado');}else{return false;}" style="cursor:pointer;"><img src="images/realizado.gif" alt="Excluir agendamento" width="24" height="16"></a></td>
                        </tr>
					<?
					}
					?>					  
