...
<%
     ...
     Dim TblPerfis, TblAcessos, TblAddPerfis
     ...
     set TblAddPerfil = ObjConn.Execute ("INSERT INTO perfil(perfil) VALUES ('" & Request("perfil") & "')")
				...
				<table border="0" cellpadding="0" cellspacing="1" width="310" bgcolor="#C0C0C0">
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
							<form method="post" name="categoria" action="add_novoperfil.asp">
