...
<%
     ...
     set TblDetrans = ObjConn.Execute ("UPDATE detrans SET status = '"& Request("status") &"', razao_social = '"& Request("razao_social") &"', nome_fantasia = '"& Request("nome_fantasia") &"', cnpj = '"& Request("cnpj") &"', ins_estadual = '"& Request("ins_estadual") &"', cidade = '"& Request("cidade") &"', uf = '"& Request("uf") &"', endereco = '"& Request("endereco") &"', cep = '"& Request("cep") &"', telefone = '"& Request("telefone") &"', email = '"& Request("email") &"', site = '"& Request("site") &"', questoes = '"& Request("questoes") &"', alternativas = '"& Request("alternativas") &"', dispensavel = '"& Request("dispensavel") &"' WHERE id = '"& Request("codcliente") &"'")
			...
			<%=Request("site")%></font></td>
							...
							<tr>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#FFFFFF">
									...
									<tr>
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="25%">
										<p align="center">
