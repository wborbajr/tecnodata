...
<%
     ...
     set TblPermissoes = ObjConn.Execute ("UPDATE usuarios SET cadastrar = '"& Request("cadastrar") &"', excluir = '"& Request("excluir") &"', editar = '"& Request("editar") &"', bilhetagem = '"& Request("bilhetagem") &"', bnq = '"& Request("bnq") &"', clientes = '"& Request("clientes") &"', usuarios = '"& Request("usuarios") &"', painel_cliente = '"& Request("painel_cliente") &"' WHERE id = '"& Request("ID") &"'")
%>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="180">
							...
							<tr>
								...
								<font size="1" color="#808080">
												<b>
												<input name="ID" READONLY type="text" class="box" size="10" maxlength="50" value="<%=TblUsuarios("ID")%>" style="color: #3672AC; border: 1px solid #F0F0F0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #F0F0F0"></b></font></td>
											</tr>
											<tr>
												<td class="texto2" height="5">
												</td>
