					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
															...
															<tr>
																...
																<table border="0" cellpadding="0" cellspacing="5" width="100%">
																	<tr>
																		...
																		<option value="<%=Tblusuarios("cadastrar")%>"><%=Tblusuarios("cadastrar")%>
																		</option>
																		<option>----
																		</option>
																		...
																		<option value="<%=Tblusuarios("excluir")%>"><%=Tblusuarios("excluir")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
																		...
																		<option value="<%=Tblusuarios("editar")%>"><%=Tblusuarios("editar")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
								...
								<font size="1" color="#808080">
												<b>
												<input name="ID" READONLY type="text" class="box" size="8" maxlength="50" value="<%=Tblusuarios("ID")%>" style="color: #F2F7F7; border: 1px solid #F2F7F7; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px; background-color: #F2F7F7; font-size:10px; font-family:Verdana; font-weight:bold; text-align:center"></b></font></td>
																	</tr>
																</table>
																</td>
															</tr>
															...
															<tr>
																...
																<table border="0" cellpadding="0" cellspacing="5" width="100%">
																	<tr>
																		...
																		<option value="<%=Tblusuarios("bilhetagem")%>"><%=Tblusuarios("bilhetagem")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
																	...
																	<tr>
																		...
																		<option value="<%=Tblusuarios("bnq")%>"><%=Tblusuarios("bnq")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
																	...
																	<tr>
																		...
																		<option value="<%=Tblusuarios("clientes")%>"><%=Tblusuarios("clientes")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
																	...
																	<tr>
																		...
																		<option value="<%=Tblusuarios("usuarios")%>"><%=Tblusuarios("usuarios")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
																	...
																	<tr>
																		...
																		<option value="<%=Tblusuarios("painel_cliente")%>"><%=Tblusuarios("painel_cliente")%>
																		</option>
																		<option>----
																		</option>
																		<option value="Sim">Sim
