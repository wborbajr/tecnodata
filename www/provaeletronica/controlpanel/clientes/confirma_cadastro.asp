...
%>
									<tr>
										<td bgcolor="#E3EEEE" class="texto2" height="30" width="100%">
																				<p align="left" style="margin-left: 10px; margin-right:10px"><font size="1" color="#47858B">
																				<%
																				Select case tipo
																					Case "Detran"
																						Response.Write "O Detran <b>"& razao_social &"</b>, foi cadastrado com sucesso."
												    								Case "Ciretran"
												       									 Response.Write "A Ciretran <b>"& razao_social &"</b>, foi cadastrada com sucesso."
																				End Select
																				%>
																				</font></td>
									</tr>
