...
<%
     ...
     Dim TblDetrans, TblAcessos, TblCustomerUser, TblDisciplinas
	...
	<table border="0" cellpadding="0" cellspacing="0" width="709">
		...
		<tr>
							...
							<tr>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#FFFFFF">
									...
									<tr>
										...
										<td bgcolor="#E3EEEE" class="texto2" height="30" width="23%" align="center">
										<font color="#47858B" size="1">Alternativas</font></td>
										<td bgcolor="#E3EEEE" class="texto2" height="30" width="27%" align="center">
										<font color="#47858B" size="1">Dispensável</font></td>
										<td bgcolor="#E3EEEE" class="texto2" height="30" width="30%" align="center">
									...
									<tr>
										...
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="23%" align="center">
			...
			<option <% if TblDetrans("alternativas") = "5" Then  Response.Write"selected"%> value="5">5</option>
										...
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="27%" align="center">
			...
			<option <% if TblDetrans("dispensavel") = "Não" Then  Response.Write"selected"%> value="Não">Não</option>
										...
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="30%" align="center">
			...
			<option <% if TblDetrans("status") = "Bloquear" Then  Response.Write"selected"%> value="Bloquear">Bloquear</option>
							...
							<tr>
								...
								<p align="right">
											...
											<tr>
												<td class="texto2" height="20" width="100%" align="right" bgcolor="#F0F0F0">&nbsp;</td>
											</tr>
											<tr>
