...
<%
     ...
     set TblAcessos = ObjConn.Execute ("SELECT * FROM acessos WHERE codUsuario = '"& Request("ID") &"'")
     set TblCurrentUser = ObjConn.Execute ("SELECT * FROM usuarios WHERE id = '"& Session("coduser") &"'")
     set TblDataAcessos = ObjConn.Execute ("SELECT DISTINCT txtData FROM acessos")
					...
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="488">
							...
							<tr>
								...
								<font size="1" color="#808080">
												<b>
												<input name="data" onkeypress="return txtBoxFormat(document.buscadata, 'data', '00/00/0000', event);" type="text" class="box" size="13" maxlength="10"></b></font></td>
														<td width="29">
														<p align="center">
