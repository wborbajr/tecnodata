...
<div align="center">
   ...
   Dim StrVar
	...
	Checa "cboEstado"
     ...
     Dim status, txtNome, txtCpf, txtEmail, txtCargo, txtCidade, cboEstado
     Dim TblUpdateUser
     ...
     Server.ScriptTimeOut = 400
     set TblUpdateUser = ObjConn.Execute ("UPDATE usuarios SET status = '"& status &"', txtNome = '"& txtNome &"', txtCpf = '"& txtCpf &"', txtEmail = '"& txtEmail &"', txtCargo = '"& txtCargo &"', cboEstado = '"& cboEstado &"', txtCidade = '"& txtCidade &"' WHERE id = '"& Request.Form("ID") &"'")
