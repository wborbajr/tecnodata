...
<?
	...
	if($_SESSION["bilhetagem"] != "Sim") {
		header("Location: ../include/logar.asp");
	}
	...
	$data = date("dmY");
	$hora = time();
	$TblAcessos = "INSERT INTO acessos(codusuario,txtPagina,txtData,txtHora,txtIP) VALUES ('" . $_SESSION["codUser"] . "','" . $pagina . "','" . $date . "','" . $hora . "','" . $ip . "')";
	$TblCategorias = "SELECT DISTINCT codDisciplina FROM questoes";
