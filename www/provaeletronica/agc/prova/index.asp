...
<%
     ...
     set TblCandidatos = ObjConn.Execute ("SELECT * FROM candidatos WHERE codCliente = '"& Session("codCliente") &"' AND dataProva = '"& date &"'")
%>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="670" bgcolor="#FFFFFF">
									...
									<tr>
										...
										<td bgcolor="#E6EEF7" class="texto2" height="30" width="22%">
																				<p style="margin-left: 5px"><font size="1" color="#3672AC"><b>Status da prova</b></font></td>
										<td bgcolor="#E6EEF7" class="texto2" height="30" width="22%">
																				<p style="margin-left: 5px"><font size="1" color="#3672AC"><b>Candidato</b></font></td>
									</tr>
									...
									<tr>
										...
										Select case TblCandidatos("status")
											Case "Em avaliação"
												Response.Write "<a href='gerar.asp?codcandidato="&TblCandidatos("ID")&"&codcliente="&TblCandidatos("codcliente")&"' class='linktx2'>Gerar</a>"
											Case "Reprovado"
										...
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="22%">
										<p style="margin-left: 5px">
										<font size="1" color="#808080"><%=TblCandidatos("status")%></font></td>
									</tr>
									<font size="2">
									<%
