...
<%
     ...
     data = date
     hora = time
     set TblClientes = ObjConn.Execute ("SELECT * FROM detrans WHERE id = '14'")
     	 If TblClientes ("Status") = "Bloquear" Then
   			Response.Redirect "bloqueado.asp"
 	     End if
     set TblUsuarios = ObjConn.Execute ("SELECT * FROM usuarios WHERE id_cliente = '14'")
     Session("codcliente") = "14"
%>
						...
						<tr>
							...
							<img border="0" src="../../controlpanel/img/linha_bra.gif" width="4" height="4"></td>
											...
											<tr>
												...
												<a class="linktx2" href="../../controlpanel/bnq/funcoes/novousuario.asp">
