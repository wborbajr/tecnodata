...
<tr>
					...
					<tr>
						...
						<td class="style7"><span class="style1 style10 style11">
						    <input name="cbINF" type="checkbox" class="boxes" id="cbINF" onClick="document.getElementById('txtNrINF').disabled=this.checked?false:true" value="true" <? if ($dados["ensino_inf"]=="t"){ echo "checked"; } ?> />
					    Infantil</span></td>
						<td><span class="style1"><span class="style7">
					  <input name="txtNrINF" type="text" disabled="disabled" id="txtNrINF" value="<? echo $dados["ensino_inf_nr"];?>" size="6" tmt:required="conditional" tmt:dependonbox="moving" tmt:message="Please enter the new job" />
						</span></span></td>
						<td><span class="texto style4 style1 style10 style11">&nbsp;<span class="style1 style10 style11">
						    <input name="cbFUNI" type="checkbox" class="boxes" id="cbFUNI" onClick="document.getElementById('txtNrFUNI').disabled=this.checked?false:true" value="true" <? if ($dados["ensino_fun1"]=="t"){ echo "checked"; } ?> />
                        </span>Fund I</span></td>
						<td align="left"><span class="style1"><span class="style7">
						  <input name="txtNrFUNI" type="text" disabled="disabled" id="txtNrFUNI" value="<? echo $dados["ensino_fun1_nr"];?>" size="6" tmt:required="conditional" tmt:dependonbox="moving" tmt:message="Please enter the new job" />
						</span></span></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td class="style7"><span class="style1 style10 style11">
						  <input name="cbMedio" type="checkbox" class="boxes" id="cbMedio" onClick="document.getElementById('txtNrMedio').disabled=this.checked?false:true" value="true" <? if ($dados["ensino_med"]=="t"){ echo "checked"; } ?>/>
 M&eacute;dio

						</span></td>
				      <td width="223"><span class="style1"><span class="style7">
				        <input name="txtNrMedio" type="text" disabled="disabled" id="txtNrMedio" value="<? echo $dados["ensino_med_nr"];?>" size="6" tmt:required="conditional" tmt:dependonbox="moving" tmt:message="Please enter the new job" />
				      </span></span></td>
					    <td><span class="texto style4 style1 style10 style11"><span class="style1 style10 style11"> 
					       &nbsp; <input name="cbFUNII" type="checkbox" class="boxes" id="cbFUNII" onClick="document.getElementById('txtNrFUNII').disabled=this.checked?false:true" value="true" <? if ($dados["ensino_fun2"]=="t"){ echo "checked"; } ?>/>
					    </span>
                        
                        Fund II</span></td>
					    <td align="left"><span class="style1"></span>					<span class="style7">
					      <input name="txtNrFUNII" type="text" disabled="disabled" id="txtNrFUNII" value="<? echo $dados["ensino_fun2_nr"];?>" size="6" tmt:required="conditional" tmt:dependonbox="moving" tmt:message="Please enter the new job" />
					    </span></tr>
<tr>
						<td>&nbsp;</td>
						<td class="style7"><span class="style1 style10 style11">
 Total
				        ...
				        <td width="223"><span class="style1"><span class="style7">
				        <input name="txtTotal" type="text" id="txtTotal" size="6">
				      </span></span></td>
					...
					<tr>
						...
						<td><span class="style1"><span class="style7 style10 style11">
						  <select name="cbSistema" id="cbSistema">
							  <option value="">Selecione</option>
							  <option value="O" <? if ($dados["sistema"]=="A"){ echo "selected"; } ?>>Ótima</option>
							  <option value="B" <? if ($dados["sistema"]=="P"){ echo "selected"; } ?>>Boa</option>
							  <option value="R" <? if ($dados["sistema"]=="T"){ echo "selected"; } ?>>Ruim</option>
			            </select>
						</span></span></td>
						...
						<td align="left"><span class="style12">
						  <select name="cbJogos" id="cbJogos">
							  <option value="">Selecione</option>
							  <option value="O" <? if ($dados["jogos"]=="A"){ echo "selected"; } ?>>Ótima</option>
							  <option value="B" <? if ($dados["jogos"]=="P"){ echo "selected"; } ?>>Boa</option>
							  <option value="R" <? if ($dados["jogos"]=="T"){ echo "selected"; } ?>>Ruim</option>
				        </select>
						</span> </td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><span class="style1"><span class="style7">
						  <select name="cbAcINET" id="cbAcINET">
							  <option value="">Selecione</option>
							  <option value="E" <? if ($dados["acessa_internet"]=="A"){ echo "selected"; } ?>>Escola</option>
							  <option value="C" <? if ($dados["acessa_internet"]=="P"){ echo "selected"; } ?>>Casa</option>
							  <option value="Y" <? if ($dados["acessa_internet"]=="T"){ echo "selected"; } ?>>Cyber</option>
							  <option value="O" <? if ($dados["acessa_internet"]=="T"){ echo "selected"; } ?>>Outros</option>
			            </select>
