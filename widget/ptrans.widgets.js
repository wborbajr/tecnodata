    ...
    var isLoad = setInterval(function(){
        try {
            ...
            if(counter>5) { // 3 seconds timeout
				//pageretorno = '<iframe src="http://noticias.uol.com.br/ultnot/primeirapagina-noticias.jhtm?first=noticias" width="160" height="376" frameborder="0" border="0" scrolling="no"></iframe>';
				pageretorno = '<iframe src="http://portaldotransito.com.br/rss/rss.php" width="160" height="376" frameborder="0" border="0" scrolling="no"></iframe>';
