...
Recordset1.Source = "SELECT CodAluno, CodCfc, LoginAluno, SenhaAluno FROM portald_portal.aluno_cfc_fidel"
...
MM_valUsername=CStr(Request.Form("LoginCfc"))
If MM_valUsername <> "" Then
  MM_fldUserAuthorization="CodCfc"
  MM_redirectLoginSuccess="administracfc.asp"
  MM_redirectLoginFailed="login.asp"
  MM_flag="ADODB.Recordset"
  set MM_rsUser = Server.CreateObject(MM_flag)
  MM_rsUser.ActiveConnection = MM_portal_STRING
  MM_rsUser.Source = "SELECT LoginCfc, SenhaCfc"
  If MM_fldUserAuthorization <> "" Then MM_rsUser.Source = MM_rsUser.Source & "," & MM_fldUserAuthorization
  MM_rsUser.Source = MM_rsUser.Source & " FROM portald_portal.transitare WHERE LoginCfc='" & Replace(MM_valUsername,"'","''") &"' AND SenhaCfc='" & Replace(Request.Form("SenhaCfc"),"'","''") & "'"
...
<!-- InstanceBeginEditable name="EditRegion1" -->
      <table width="100%" class="conteudo">
              ...
              <tr>
                <td valign="top"><div align="center" class="box3">Insira seu Login e Senha </div></td>
              </tr>
			  <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td><form id="form1" name="form1" method="post" action="<%=MM_LoginAction%>">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3" class="conteudo">
                    <tr>
                      <td width="40%"><div align="right"><strong>Login</strong></div></td>
                      <td width="60%"><label>
                        <input name="LoginCfc" type="text" id="LoginCfc" />
                      </label></td>
                    </tr>
                    <tr>
                      <td width="40%"><div align="right"><strong>Senha</strong></div></td>
                      <td width="60%"><label>
                        <input name="SenhaCfc" type="password" id="SenhaCfc" />
                      </label></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
