              ...
              <tr>
                <td><div align="center">
                    <table width="300" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><p><a href="cadastra_aluno.asp" class="conteudo">Cadastrar Alunos</a></p>
                            <p><a href="relatorioalunos.asp" class="conteudo">Relat&oacute;rio dos Alunos cadastrados</a></p>
                          <p><a href="totalizador.asp" class="conteudo">Totalizador</a></p></td>
                      </tr>
                    </table>
                </div></td>
              </tr>
