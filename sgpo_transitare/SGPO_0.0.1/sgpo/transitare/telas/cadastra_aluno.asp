...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_editTable = "portald_portal.aluno_cfc_fidel"
  MM_editRedirectUrl = "http://www.portaldotransito.com.br/cfcs/cfccorreto.asp"
  MM_fieldsStr  = "CodCfc|value|NomeAluno|value|CpfAluno|value|EmailAluno|value|PagamentoAluno|value"
  MM_columnsStr = "CodCfc|none,none,NULL|NomeAluno|',none,''|CpfAluno|',none,''|EmailAluno|',none,''|PagamentoAluno|none,none,NULL"
...
Recordset1.Source = "SELECT * FROM portald_portal.aluno_cfc_fidel"
...
If (Session("MM_UserAuthorization") <> "") Then 
  Recordset2__MMColParam = Session("MM_UserAuthorization")
End If
%>
<%
Dim Recordset2
...
<!-- InstanceBeginEditable name="EditRegion1" -->
            ...
            <table width="100%" class="conteudo">
              ...
              <tr>
                <td valign="top"><div align="center" class="box3">Cadastro de alunos</div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td><div align="center">
                    <form id="form1" name="form1" method="post" action="<%=MM_editAction%>">
                      <table width="400" border="0" class="conteudo">
                        <tr>
                          <td colspan="2"><strong><%=(Recordset2.Fields.Item("NomeCfc").Value)%></strong>
                              <label>
                              <input name="CodCfc" type="hidden" id="CodCfc" value="<%= Session("MM_UserAuthorization") %>" <%=Request.QueryString("CodCfc")%> />
                            </label></td>
                        </tr>
                        <tr>
                          <td width="177">Nome do aluno </td>
                          <td width="213"><label>
                            <input name="NomeAluno" type="text" id="NomeAluno" />
                          </label></td>
                        </tr>
                        <tr>
                          <td>CPF do aluno </td>
                          <td><label>
                            <input name="CpfAluno" type="text" id="CpfAluno" />
                          </label></td>
                        </tr>
                        <tr>
                          <td>E-mail do aluno </td>
                          <td><label>
                            <input name="EmailAluno" type="text" id="EmailAluno" />
                          </label></td>
                        </tr>
                        <tr>
                          <td colspan="2"><label>
