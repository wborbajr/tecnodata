...
'     set TblQuestoes = ObjConn.Execute ("SELECT * FROM questoes WHERE codDisciplina AND codAssunto AND primeirahabilitacao = 'S'")
     set TblQuestoes = ObjConn.Execute ("SELECT questoes.codQuestao AS codQuestao, questoes.codDificuldade AS codDificuldade, disciplinas.codDisciplina AS codDisciplina, disciplinas.Disciplina AS Disciplina, assuntos.codAssunto AS codAssunto, assuntos.Assunto AS Assunto FROM questoes INNER JOIN disciplinas ON questoes.codDisciplina = disciplinas.codDisciplina INNER JOIN assuntos ON questoes.codAssunto = assuntos.codAssunto  WHERE questoes.codAssunto AND questoes.codDisciplina AND questoes.primeirahabilitacao = 'S'")
