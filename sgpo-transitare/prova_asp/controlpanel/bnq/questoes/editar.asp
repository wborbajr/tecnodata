				...
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
											...
											<form method="post" name="questoes" action="atualiza_questao.asp">
												<tr>
													...
													<td bgcolor="#FFFFFF" height="25" width="82%" class="texto2">
															<table border="0" cellpadding="0" cellspacing="0" width="90%" id="table4">
																<tr>
																	...
																	<input type="radio" value="Livre" name="status" <% if TblQuestoes("status") = "Livre" Then  Response.Write"checked"%>></td>
																	<td height="20" class="texto2" width="20%">
																	Disponível</td>
																	<td height="20" class="texto2" width="5%">
																	<p align="center">
																	<input type="radio" value="Bloqueado" name="status" <% if TblQuestoes("status") = "Bloqueado" Then  Response.Write"checked"%>></td>
																	<td height="20" class="texto2" width="20%">
																	Bloqueada</td>
																	<td height="20" class="texto2" width="5%">
																	<p align="center">
											...
											<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#C0C0C0">
												...
												<tr>
													...
													<p style="margin-left: 10px">
														...
														<option <% if TblQuestoes("dispensavel") = "1" Then  Response.Write"selected"%> value="1">Resp1</option>
														<option <% if TblQuestoes("dispensavel") = "2" Then  Response.Write"selected"%> value="2">Resp2</option>
														<option <% if TblQuestoes("dispensavel") = "3" Then  Response.Write"selected"%> value="3">Resp3</option>
														<option <% if TblQuestoes("dispensavel") = "4" Then  Response.Write"selected"%> value="4">Resp4</option>
														<option <% if TblQuestoes("dispensavel") = "5" Then  Response.Write"selected"%> value="5">Resp5</option>
														</select></td>
													<td bgcolor="#FFFFFF" height="50" width="17%" class="texto2">
													<p style="margin-left: 10px">
															<select size="1" name="correta" class="box">
															<option value="1" <% if TblQuestoes("correta") = "1" Then  Response.Write"selected"%>>Resp 1</option>
															<option value="2" <% if TblQuestoes("correta") = "2" Then  Response.Write"selected"%>>Resp 2</option>
															<option value="3" <% if TblQuestoes("correta") = "3" Then  Response.Write"selected"%>>Resp 3</option>
															<option value="4" <% if TblQuestoes("correta") = "4" Then  Response.Write"selected"%>>Resp 4</option>
															<option value="5" <% if TblQuestoes("correta") = "5" Then  Response.Write"selected"%>>Resp 5</option>
															</select></td>
								...
								<tr>
											...
											<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#C0C0C0">
												...
												<tr>
													...
													<img border="0" src="<%=server.MapPath("../../../prova/placas/"& TblQuestoes("img1") &"")%>">&nbsp;&nbsp;&nbsp;&nbsp;
													<img border="0" src="<%=server.MapPath("../../../prova/placas/"& TblQuestoes("img2") &"")%>"></td>
												</tr>
												</table>
											</td>
										</tr>
