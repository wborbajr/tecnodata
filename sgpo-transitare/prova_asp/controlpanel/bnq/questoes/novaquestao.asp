							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
											...
											<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#C0C0C0">
												...
												<tr>
													<td bgcolor="#F2F7F7" height="35" width="14%" class="texto2">
													<p style="margin-left: 10px">
													<font size="1" color="#47858B">
													Dispensável:</font></td>
													<td bgcolor="#FFFFFF" height="35" width="16%" class="texto2">
													<p style="margin-left: 10px">
													...
													<td bgcolor="#F2F7F7" height="35" width="69%" class="texto2">
													<p style="margin-left: 10px">
													<font size="1" color="#47858B">
													Cursos vinculados à esta 
													questão:</font></td>
												</tr>
												<tr>
													<td bgcolor="#F2F7F7" height="35" width="14%" class="texto2">
													...
													<td bgcolor="#FFFFFF" height="35" width="16%" class="texto2">
													<p style="margin-left: 10px">
															<select size="1" name="correta" class="box" style="width: 80">
													...
													<td bgcolor="#FFFFFF" height="70" width="69%" class="texto2" rowspan="2">
													<div align="center">
														<table border="0" cellpadding="0" cellspacing="0" width="470">
															<tr>
																<td height="20" class="texto2" align="center" width="46%">
																<font color="#808080">
																Cursos 
																disponíveis</font></td>
																<td height="20" class="texto2" align="center" width="8%">
																&nbsp;</td>
																<td height="20" class="texto2" align="center" width="46%">
																<font color="#808080">
																Cursos 
															...
															<tr>
																<td height="30" class="texto2" align="center" width="46%">
															<select size="3" name="cursos" class="box" style="width:180; height:42" multiple>
															<% While Not TblCursos.EOF %>
														<option value="<%=TblCursos("curso")%>"><%=TblCursos("curso")%></option>
														    <%
														    TblCursos.MoveNext
														    Wend
														    %>
														</select></td>
																<td height="30" class="texto2" align="center" width="8%">
															<p style="margin-top: 1px; margin-bottom: 1px">
												<input type="submit" value="«" name="btoRemover" style="font-size: 9px; font-family: Verdana; font-weight: bold"><input type="submit" value="»" name="btoIncluir" style="font-size: 9px; font-family: Verdana; font-weight: bold"></td>
																<td height="30" class="texto2" align="center" width="46%">
															<select size="3" name="cursosvinculados" class="box" style="width:180; height:42" multiple>
															<% While Not TblCursos.EOF %>
														<option value="<%=TblCursos("curso")%>"><%=TblCursos("curso")%></option>
														    <%
														    TblCursos.MoveNext
												...
												<tr>
													...
													<td bgcolor="#FFFFFF" height="35" width="16%" class="texto2">
													<p style="margin-left: 10px">
															<select size="1" name="dificuldade" class="box" style="width: 80">
