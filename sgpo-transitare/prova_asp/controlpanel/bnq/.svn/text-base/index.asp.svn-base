...
<%
     ...
     set TblInstrutor = ObjConn.Execute ("SELECT Count(*) as InsQuestoes FROM questoes WHERE Instrutor = 'S'")
     set TblPrimeiraHabilitacao = ObjConn.Execute ("SELECT Count(*) as PHQuestoes FROM questoes")
     set TblReciclagem = ObjConn.Execute ("SELECT Count(*) as RecQuestoes FROM questoes WHERE reciclagem = 'S'")
     set TblRenovacao = ObjConn.Execute ("SELECT Count(*) as RenQuestoes FROM questoes WHERE renovacao = 'S'")
	...
	<table border="0" cellpadding="0" cellspacing="0" width="709">
		...
		<tr>
			<td colspan="2">
											...
											<form method="post" name="passo1" action="../clientes/prova_passo2.asp">
												<tr>
													<td bgcolor="#F2F7F7" class="texto2" height="30" width="100%" colspan="8">
													<p style="margin-left: 10px; margin-right: 10px; ">
													<font size="1" color="#47858B">
													<b>Estatísticas de questões 
													para cada curso:</b></font></td>
												</tr>
												<tr>
													...
													<b>
													<a class="linktx2" href="lista_bd_bnq.asp?curso=instrutor">
													<font color="#808080">Instrutor:</font></a></b></font></td>
													<td bgcolor="#FFFFFF" class="texto2" height="30" width="10%">
													<p align="center"><b>
													<font size="2"><%=TblInstrutor("InsQuestoes")%></font></b></td>
													<td bgcolor="#F0F0F0" class="texto2" height="30" width="15%">
													<p style="margin-left: 10px; ">
													<font size="1" color="#808080">
													<b>
													<a class="linktx2" href="lista_bd_bnq.asp?curso=primeirahabilitacao">
													<font color="#808080">Primeira Habilitação:</font></a></b></font></td>
													<td bgcolor="#FFFFFF" class="texto2" height="30" width="10%" align="center">
													<b><font size="2">
													<%=TblPrimeiraHabilitacao("PHQuestoes")%></font></b></td>
													<td bgcolor="#F0F0F0" class="texto2" height="30" width="15%">
													<p style="margin-left: 10px; ">
													<font size="1" color="#808080">
													<b>
													<a class="linktx2" href="lista_bd_bnq.asp?curso=reciclagem">
													<font color="#808080">Reciclagem:</font></a></b></font></td>
													<td bgcolor="#FFFFFF" class="texto2" height="30" width="10%" align="center">
													<b><font size="2">
													<%=TblReciclagem("RecQuestoes")%></font></b></td>
													<td bgcolor="#F0F0F0" class="texto2" height="30" width="15%">
													<p style="margin-left: 10px; ">
													<font size="1" color="#808080">
													<b>
													<a class="linktx2" href="lista_bd_bnq.asp?curso=renovacao">
													<font color="#808080">Renovação:</font></a></b></font></td>
													<td bgcolor="#FFFFFF" class="texto2" height="30" width="10%" align="center">
													<b><font size="2">
													<%=TblRenovacao("RenQuestoes")%></font></b></td>
												</tr>
												</table>
			</td>
			</tr>
														...
														<tr>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	...
																	<p style="margin-left:7px; margin-right:10px; margin-top:10px; margin-bottom:10px">
																	<b>
																	<font size="1" color="#808080">
																	Selecione 
																	uma 
