...
<%
     ...
     Dim TblCategorias, TblQuestoes, numquestoes
				...
				<tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									...
									<b>
									<font size="2" face="verdana, tahoma, arial" color="#CC0000">- Nenhuma questão encontrada com "<%=Request.Form("busca")%>" -</font></b><font size="2">
									<%
									...
									%>
										  <td bgcolor="#FFFFFF" class="texto2" width="72%"><p style="margin-left: 5px">
											...
											<p style="margin-left: 5px">
											<font size="1"><%=TblQuestoes("codDisciplina")%></font></td>
