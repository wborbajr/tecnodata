...
<div align="center">
											<table border="0" cellpadding="0" cellspacing="1" width="320" bgcolor="#C0C0C0">
												...
												<form method="post" name="imgupdate" action="upload.asp">
													<td bgcolor="#FFFFFF" height="30" width="99%" class="texto2">
													<p style="margin-left: 10px">
								<font size="1" color="#808080">
												<b>
												<input name="img1" type="text" class="box" size="50" maxlength="50" value="none.gif"></b></font></td>
													</tr>
												<tr>
													<td bgcolor="#F2F7F7" height="20" width="100%" class="texto2">
													<p style="margin-left: 10px">
								...
								<font size="1" color="#808080">
												<b>
												<input name="img2" type="text" class="box" size="50" maxlength="50" value="none.gif"></b></font></td>
												</tr>
												<tr>
