					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<font size="1" color="#808080">Nome da categoria:</font></b></td>
							</tr>
							<tr>
							<form method="post" name="categoria" action="novacategoria.asp">
			...
			<div align="center">
				<table border="0" cellpadding="0" cellspacing="1" width="310" bgcolor="#C0C0C0">
					...
					<tr>
						...
						<p align="left" style="margin-left: 10px">
						<font size="1" color="#808080"><%=TblDisciplinas("disciplina")%></font></td>
					</tr>
					<%
