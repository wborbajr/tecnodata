...
<div align="center">
  ...
  Select Case Request.QueryString("reacao")
       Case 1:
            Response.Write "Você não está cadastrado no sistema."
       Case 2:
            Response.Write "<b>"& Session("txtNome") &"</b><br>Você já cadastrado no sistema, porém seus dados ainda estão em processo de análise pelo administrador."
       Case 3:
       ...
       Case 4:
            Response.Write "Você está temporariamente sem acesso ao sistema. Por favor, entre em contato com o administrador."
       Case 5:
            Response.Write "Logon bloqueado."
       Case 6:
