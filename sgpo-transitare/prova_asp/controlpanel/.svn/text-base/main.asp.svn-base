								...
								<tr>
									...
									<table border="0" cellpadding="0" width="100%" cellspacing="3">
										<tr>
											...
											<iframe name=frame align=left src="<%=url%>" scrolling=yes frameborder=0 width=729 height=300 border="0"></iframe>
											</td>
										</tr>
									</table>
									</td>
