					...
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<font size="1" color="#808080">
												<b>
												<input name="ID" READONLY type="text" class="box" size="10" maxlength="50" value="<%=TblUsuarios("codUsuario")%>"></b></font></td>
							</tr>
							<tr>
								<td height="25" class="texto2" width="106">
								<b>
							...
							<tr>
								...
								<td height="25" class="texto2"><b>						<font size="1" color="#808080">
										<input name="txtSenha" type="password" class="box" size="20" maxlength="20" value="<%=TblUsuarios("txtSenha")%>"></font></b></td>
							</tr>
							<tr>
								<td height="10" class="texto2" colspan="2">
								</td>
