												...
												<tr>
													...
													<table border="0" cellpadding="0" cellspacing="5" width="100%" id="table11">
														...
														<% While Not TblDetrans.EOF %>
															<td>
															<table border="0" cellpadding="0" cellspacing="1" width="27%" bgcolor="#C0C0C0" id="table12">
																
																<tr>
																	<td bgcolor="#F2F7F7" height="20" class="texto2" align="center" width="27%" colspan="3">
																	<font size="1" color="#47858B">
																	<b>
																	<%=TblDetrans("uf")%></b></font></td>
																</tr>														
																<tr>
																	<td bgcolor="#F2F7F7" height="20" class="texto2" align="center" width="9%">
																	<font color="#47858B">
																	...
																	<font color="#47858B">
																	<span style="font-size: 6pt">
																	Difícil</span></font></td>
																</tr>
																<% While Not TblDisciplinas.EOF %>
																<tr>
																	<td bgcolor="#FFFFFF" height="30" class="texto2" align="center" width="27%" colspan="3">
															<input type="text" name="<%=TblDisciplinas("codDisciplina")%>_facil" size="5" class="box"><input type="text" name="<%=TblDisciplinas("codDisciplina")%>_medio" size="5" class="box"><input type="text" name="<%=TblDisciplinas("codDisciplina")%>_dificil" size="5" class="box"></td>
																</tr>
																<%
																...
																<tr>
																	<td bgcolor="#FFFFFF" height="30" class="texto2" align="center" width="27%" colspan="3">
												<input type="submit" value="» | Salvar" name="btoSalvar" style="font-size: 9px; font-family: Verdana; font-weight: bold"></td>
																</tr>
																</table>
															</td><%
															TblDetrans.MoveNext
