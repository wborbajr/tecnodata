...
<%
     ...
     Dim TblDetrans, TblAcessos, TblCustomerUser, TblDisciplinas, TblCursosLiberados
     ...
     set TblDetrans    = ObjConn.Execute ("SELECT * FROM detrans WHERE codCliente = '"& Request("id") &"'")
     set TblCustomerUser    = ObjConn.Execute ("SELECT * FROM usuarios WHERE codCliente = '"& Request("id") &"'")
     set TblDisciplinas    = ObjConn.Execute ("SELECT * FROM disciplinas")
     set TblCursosLiberados    = ObjConn.Execute ("SELECT * FROM cursos_liberados WHERE codCliente = '"& Request("id") &"'")
%>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="709">
		...
		<tr>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#FFFFFF">
									...
									<tr>
										...
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="70%">
														...
														<input type="text" READONLY name="codcliente" size="10" class="box" value="<%=TblDetrans("codCliente")%>">
														<font color="#C0C0C0">
			...
			<font size="1" color="#808080">%</font></td>
							...
							<tr>
								<td height="20" class="texto2">
								<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#FFFFFF" id="table7">
									<tr>
										<td class="texto2" height="30" colspan="2">
										<p style="margin-left: 5px; margin-right:10px" align="right">
										<font size="1" color="#47858B"><b>
										Configuração da mensagem de conclusão da 
										prova :</b></font></td>
									</tr>
									<tr>
										<td bgcolor="#E3EEEE" class="texto2" height="70" width="30%" align="center">
																				<p align="left" style="margin-left: 5px"><font size="1" color="#47858B">Mensagem de aprovação:</font></td>
										<td bgcolor="#F0F0F0" class="texto2" height="70" width="69%" align="center">
																				<p align="left" style="margin-left: 7px"><textarea rows="4" name="mensagem_aprovado" cols="54" class="box"><%=TblDetrans("mensagem_aprovado")%></textarea></td>
									</tr>
									<tr>
										<td bgcolor="#E3EEEE" class="texto2" height="70" width="30%" align="center">
																				<p align="left" style="margin-left: 5px"><font size="1" color="#47858B">Mensagem de reprovação:</font></td>
										<td bgcolor="#F0F0F0" class="texto2" height="70" width="69%" align="center">
																				<p align="left" style="margin-left: 7px"><textarea rows="4" name="mensagem_reprovado" cols="54" class="box"><%=TblDetrans("mensagem_reprovado")%></textarea></td>
									</tr>
									</table>
								</td>
							</tr>
							<tr>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="450" bgcolor="#FFFFFF" id="table1">
									...
									<tr>
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="25%" align="center">
																				<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table2">
																					<tr>
																						<td align="center"><input type="radio" value="Sim" name="primeirahabilitacao"></td>
																						<td class="texto2"><font color="#808080">Sim</font></td>
																						<td align="center"><input type="radio" value="Não" name="primeirahabilitacao"></td>
																						<td class="texto2"><font color="#808080">Não</font></td>
																					</tr>
																				</table>
										</td>
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="25%" align="center">
			<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table3">
				<tr>
					<td align="center">
					<input type="radio" value="Sim" name="instrutor"></td>
					<td class="texto2"><font color="#808080">Sim</font></td>
					<td align="center">
					<input type="radio" value="Não" name="instrutor"></td>
					<td class="texto2"><font color="#808080">Não</font></td>
				</tr>
			</table>
										</td>
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="25%" align="center">
			<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table4">
				<tr>
					<td align="center">
					<input type="radio" value="Sim" name="reciclagem"></td>
					<td class="texto2"><font color="#808080">Sim</font></td>
					<td align="center">
					<input type="radio" value="Não" name="Reciclagem"></td>
					<td class="texto2"><font color="#808080">Não</font></td>
				</tr>
			</table>
										</td>
										<td bgcolor="#F0F0F0" class="texto2" height="30" width="25%" align="center">
			<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table5">
				<tr>
					<td align="center">
					<input type="radio" value="Sim" name="renovacao"></td>
					<td class="texto2"><font color="#808080">Sim</font></td>
					<td align="center">
					<input type="radio" value="Não" name="renovacao"></td>
					<td class="texto2"><font color="#808080">Não</font></td>
				</tr>
			</table>
										</td>
											...
											<tr>
												<td class="texto2" height="10" width="100%" align="left" bgcolor="#F0F0F0">
												&nbsp;</td>
											</tr>
											<tr>
												<td class="texto2" height="20" width="100%" align="left" bgcolor="#F0F0F0">
												<div align="center">
													<table border="0" cellpadding="0" cellspacing="0" width="450" id="table6">
														<tr>
															<td>
								<p align="right">
								...
								<table border="0" cellpadding="0" cellspacing="1" width="450" bgcolor="#FFFFFF">
									...
									<tr>
										...
										<font size="1" color="#808080"><%=TblCustomerUser("codUsuario")%></font></td>
