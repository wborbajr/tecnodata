...
<%
     ...
     Dim TblCursos, TblAcessos, TblDisciplinas, TblDisciplinas_cursos
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<form method="post" name="categoria" action="add_parametros.asp">
								...
								<p style="margin-left: 5px">
															<input type="hidden" name="codCurso" size="20" value="<%=Request("codCurso")%>"><select size="1" name="codDisciplina" class="box">
