...
<%
     ...
     Dim TblCursos, TblAcessos, TblAddCursos, TblDelCursos
     ...
     set TblAddCursos = ObjConn.Execute ("INSERT INTO cursos(curso) VALUES ('" & Request("curso") & "')")
			...
			<div align="center">
				<table border="0" cellpadding="0" cellspacing="1" width="310" bgcolor="#C0C0C0">
					...
					<tr>
						...
						<p align="left" style="margin-left: 10px">
						<font size="1" color="#808080"><%=TblCursos("curso")%></font></td>
					</tr>
					<%
					TblCursos.MoveNext
					Wend
