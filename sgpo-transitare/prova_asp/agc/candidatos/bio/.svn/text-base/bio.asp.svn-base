			...
			<div align="center">
				...
				<input type=hidden name='FIRTextData'>
					<tr>
						...
						<font size="1" color="#808080"><b>RENACH</b></font><b><font size="1" color="#808080">:</font></b></p>
					...
					<tr>
						...
						<p style="margin-left: 5px">
								<font size="1" color="#808080">
												<b>
												<input name="UserID" type="text" class="box" size="55" maxlength="50" value="<%=Session("Renach")%>">
												</b></font></td>
					</tr>
					</table>
			</div>
