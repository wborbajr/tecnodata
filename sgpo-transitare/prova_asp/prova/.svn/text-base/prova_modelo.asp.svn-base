...
<%
     ...
     set TblQuestoes    = ObjConn.Execute ("SELECT questoes.codQuestao AS codQuestao, "&_
					      ...
					      " provas_geradas.codCandidato = (SELECT codCandidato FROM candidatos WHERE renach = "& Session("renach") &")")
...
<div align="center">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="table1">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" id="table20">
			...
			<td width="80%" height="500" bgcolor="#FFFFFF" valign="top">
			<div align="center">
						...
						<font face="Arial" size="2">
																	...
																	<tr>
																		...
																		<table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#EBF1FA" id="table4">
							    <%
								Dim alternativa
								...
								%>
																			<tr>
																				...
																				End select
																				%></b></font></td>
																				<td height="40" class="texto1" bgcolor="#FFFFFF">
																				<p style="margin: 5px 10px"><%=TblQuestoes("Resp"& alternativa &"")%></td>
									<% next %>
																			</tr>
																		</table>
																		</td>
															...
															%>
																								...
																								<div align="center">
																									<table border="1" cellpadding="0" cellspacing="0" width="90%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" class="texto2" bgcolor="#E0DFE3" id="table27">
																										<tr>
																		<%
																		...
																		%>
																					...
																					<td bgcolor="#EBF1FA" width="381"><font size="2">
																					<div align="center">
																						<table border="0" cellpadding="0" cellspacing="0" width="100%" height="30" id="table31">
																							<tr>
																								...
																								<td width="50%"><font size="2">
																								<div align="center">
																									<table border="1" cellpadding="0" cellspacing="0" width="90%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" class="texto2" bgcolor="#E0DFE3" id="table33">
																					...
																					<td bgcolor="#F0F0E6" width="133"><font size="2">
																					<div align="center">
																						<table border="1" cellpadding="0" cellspacing="0" width="80%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" class="texto2" bgcolor="#E0DFE3" id="table17">
																							<tr>
																								...
																								<p align="center"><b>» | Concluir</b></td></a>
																							</tr>
																						</table></div></font></td>
																				</tr>
																			</table>
							...
							<td>
							<table border="0" cellpadding="0" cellspacing="1" width="100%" id="table12">
								<tr>
									<td height="20">
									<div align="center">
										<table border="0" cellpadding="0" cellspacing="1" width="20" height="20" id="table13" bgcolor="#3672AC">
											<tr>
							...
							%>	
							<td>
							<table border="0" cellpadding="0" cellspacing="1" width="100%" id="table36">
								<tr>
									<td height="20">
									<div align="center">
										<table border="0" cellpadding="0" cellspacing="0" width="20" height="20" id="table37">
			...
			<td valign="top" colspan="3" height="5" bgcolor="#3672AC"></td>
		</tr>
	</table>
</div>
</body>
