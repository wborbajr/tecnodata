			...
			<tr>
				...
				<div align="center">
					<table border="0" cellpadding="0" cellspacing="0" width="90%">
						...
						<tr>
							<td class="texto2">
							<p align="left" style="margin-left: 5px">Informe seu 
							RG:</td>
							<form method="post" name="prova" action="prova.asp">
							<td class="texto2">
														<p align="left">
														<input type="text" name="rg" size="16" class="box" style="height: 40; text-align:center; font-size:14pt; font-family:Verdana; font-weight:bold; color:#1E1E1E; padding-top:9px" maxlength="14"></td>
							<td class="texto2">
