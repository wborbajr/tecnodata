...
<!-- InstanceBeginEditable name="EditRegion1" -->
      <table width="100%" border="0">
			...
			<tr>
              <td><div align="center" class="box3">Relat&oacute;rio de alunos cadastrados </div></td>
            </tr>
            <tr>
              <td><% 
...
%>
                  <table width="100%" border="0">
                    <tr>
                        <td width="42%" class="Anuncio"><div align="right"><strong>Nome</strong></div></td>
                      <td width="58%" class="conteudo"><%=(Recordset1.Fields.Item("NomeAluno").Value)%></td>
                    </tr>
                    <tr>
                        <td class="Anuncio"><div align="right"><strong>CPF</strong></div></td>
                        <td class="conteudo"><%=(Recordset1.Fields.Item("CpfAluno").Value)%></td>
                    </tr>
                    <tr>
                        <td class="Anuncio"><div align="right"><strong>E-mail</strong></div></td>
                        <td class="conteudo"><%=(Recordset1.Fields.Item("EmailAluno").Value)%></td>
                    </tr>
                    <tr>
                        <td class="Anuncio"><div align="right"><strong>Data</strong></div></td>
                        <td class="conteudo"><%=(Recordset1.Fields.Item("DataAluno").Value)%></td>
                    </tr>
                    <tr>
