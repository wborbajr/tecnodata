  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="150">
	            <input name="ref_legal_voltar" type="button" class="botoes" id="ref_legal_voltar" value="VOLTAR" />        </td>
      </tr>
      <tr>
...
?>
            <tr id="tr_destaque" onclick="questao_edita(<?=$data['bnq_id']?>)">

              <td width="40" class="tabelas" align="center">
                  <?=(($data['bnq_simulado']==1)?'SIM':'não')?>
              </td>
...
function questao_edita(id){
//   win_questao_edita = window.open("questao_edita.php?id="+id, "_blank");
   $("#conteudo_edit").load("questao_edita.php", {id: id});
