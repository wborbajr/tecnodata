...
Sys.Silverlight.createObject = function(source, parentElement, id, properties, events, initParams, userContext)
{
    ...
    if (minorVer == "95")
    {
        ...
        inDirectDownloadPage = "http://www.microsoft.com/silverlight";
        inDirectDownloadImage = "http://jscratch/cguinan/SilverlightInstall/WebPrompt-Indirect.png";
    }
    else
    {
        inDirectDownloadPage = "http://www.microsoft.com/silverlight";
    ...
    {   
        ...
        { 
            slPluginHTML += '<div style="width: 205px; height: 101px background-color: #FFFFFF;"><a href="'+directDownload+'"><img style="border:0"; SRC="http://jscratch/cguinan/SilverlightInstall/WebPrompt-Direct.png"></a>';                
            ...
            slPluginHTML += '<a href="http://jscratch/cguinan/SilverlightInstall/EULA.html" style="text-decoration: underline;color: #FFFFFF;">Silverlight license agreement.</a></div>';                
            slPluginHTML += '<div style="margin-top: 8px;text-align: center;color: #FFFFFF; font-family: Arial; font-size: 10px;">Silverlight updates automatically, <a href="http://jscratch/cguinan/SilverlightInstall/Privacy.html" style="text-decoration: underline;color: #FFFFFF;">learn more.</a></div></div>';
